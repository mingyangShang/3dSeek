...
def k_d_tree_dump():
    X = np.load(r'D:\Workspace\bishe\3dSeek\static\database\wxy\features\fc_feature_mat_10_test.npy')
    print(X.shape)
    tree = KDTree(X)
    ...
    print(name_list)
    # joblib.dump(tree, r'D:\Workspace\bishe\3dSeek\static\database\wxy\kd_tree.pkl')
